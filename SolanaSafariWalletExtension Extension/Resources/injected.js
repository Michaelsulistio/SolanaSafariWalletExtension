(() => {
  ...
  var _name, _version, _icon2, _listeners, _accounts, _chains2, _connected, _disconnected, _standardEventsOn, _standardEventsOff, _standardEventsEmit, _standardConnect, _standardDisconnect, _solanaSignAndSendTransaction, _solanaSignIn, _solanaSignMessage, _solanaSignTransaction;
  var _MyWallet = class {
    constructor() {
      ...
      _standardEventsEmit.set(this, (event, ...args) => {
        ...
        ((_b = (_a = __privateGet(this, _listeners))[event]) != null ? _b : _a[event] = []).forEach((listener) => listener.apply(null, args));
      });
